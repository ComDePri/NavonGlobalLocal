...
var instructions_block = {
  ...
  pages: [
    ...
    '<div class = centerbox><p class = block-text>Please make sure your keyboard is set to English.</p></div>',
    '<div class = centerbox><p class = block-text>If you are not active in the task, we may ask you to return your submission, Good luck!</p></div>',
],
  allow_keys: false,
